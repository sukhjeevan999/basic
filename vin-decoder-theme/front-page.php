	...
	<div class="vd-container">
		...
		<div class="vd-trust-row">
			<div class="vd-trust-item">
				<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 2 4 5v6c0 5 3.4 8.7 8 10 4.6-1.3 8-5 8-10V5l-8-3Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/></svg>
				<span><?php esc_html_e( 'Official U.S. NHTSA data', 'vindecodertheme' ); ?></span>
			</div>
			<div class="vd-trust-item">
				<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M5 12h14M5 12l4-4M5 12l4 4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
				<span><?php esc_html_e( '25 brands, one decoder each', 'vindecodertheme' ); ?></span>
			</div>
			<div class="vd-trust-item">
				<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
<section class="vd-content-section" style="padding-top: 0;">
	<div class="vd-container">
		<div class="vd-prose">
			...
			<?php echo vindecoder_author_box_shortcode(); ?>
			<p><a href="<?php echo esc_url( home_url( '/about/' ) ); ?>"><?php esc_html_e( 'Read the full story', 'vindecodertheme' ); ?> →</a></p>
		</div>
	</div>
</section>
